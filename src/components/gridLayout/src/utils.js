...
export function withLayoutItem(layout: Layout, itemKey: string, cb: (LayoutItem) => LayoutItem): [Layout, ?LayoutItem] {
...
export function compactType(props: ?{ verticalCompact: boolean, compactType: CompactType }): CompactType {
