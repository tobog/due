<template>
    <section :class="classes" :data-vue-module="$options.name" :style="getStyle">
        <slot></slot>
    </section>
</template>
...
export default {
    ...
    methods: {
            ...
            this.$nextTick(() => {
                ...
                for (let i = 0; i < length; i++) {
                    ...
                    if (i < column) {
                        ...
                        child.position = [
                            index * 100 + "%",
                            heightArr[index] + gap1 + "px",
                            unit(gap0, index + gapNum),
                        ];
                        child.index = `${index}-${i};`;
        ...
        refresh() {
            return this.__getClientSize && this.__getClientSize();
        },
    },
    watch: {
        type() {
