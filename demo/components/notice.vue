        ...
        getBase() {
            return [
                ...
                },
                {
                    ...
                    tag: "vSelect",
                    default: "",
                    options: ["bottom-left", "top-left", "bottom-center", "top-center", "bottom-right", "top-right"],
                },
                {
                    label: "通知提醒的标题",
                    key: "title",
        ...
        compProps() {
            return [
                ...
                },
                {
                    prop: "JS:options",
                    explain:
                        "就是调用属性：maskable,content ,closable = true,onClose,render,duration,name,style,className,ghost",
                    type: "Object",
                    default: "-",
                },
            ];
