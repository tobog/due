...
<template>
    <vRow class="demo-layout" flex>
        ...
        <vCol lg="10" span="24" class="demo-view">
            ...
            <section v-if="show">
                <vCircle v-model="val" v-bind="formData">{{ formData.percent }}%</vCircle>
                <vCircle v-model="val" v-bind="formData">
                    <vIcon type="ios-checkmark" size="60" style="color:#5cb85c"></vIcon>
                </vCircle>
                <vCircle v-bind="formData" stroke-color="#ff5500">
    ...
    computed: {
        ...
        compProps() {
            return [
                ...
                {
                    explain: '环顶端的形状:可选值square, round, butt, inherit',
                    prop: 'strokeLinecap',
                    type: 'vSelect',
                    default: 'round',
                },
