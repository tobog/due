	...
	computed: {
		...
		compProps() {
			return [
				...
				{
					explain:
						"边框:'default', 'none', 'both', 'horizontal', 'vertical'",
					prop: "border",
					type: "String",
					default: ""
				},
				...
				},
				{
					...
					type: "Function:Event",
					default:
						"(data, checkVals,{ key, status: true, type: selectAll' })=>{}"
				},
				{
					prop: "on-select-change",
					explain: "取消选中某一项时触发",
					type: "Function:Event",
					default:
						"(curdata, curval,{ key, status: true,value: curval, index, type: 'select' })=>{}"
				},
				{
					...
					type: "Function:Event",
					default:
						"(curdata, curval,{ key, status: true,value: curval, index, type: 'radio' })=>{}"
				},
				{
					prop: "on-sort-change",
			...
			return [
				{
					prop: "type",
					explain:
						"列类型，可选值为 index、selection、expand、html,template",
					type: "String",
					default: "-"
				},
				{
