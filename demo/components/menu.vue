			...
			<section v-if="show">
				<vCol span="12">
					<vMenu v-bind="formData" style="border:1px solid #ddd">
						<vMenuItem>
							<div slot="title">
								<vIcon type="ios-analytics" />内容管理0
							</div>
							<vMenuItem>
								<div slot="title">
									<vIcon type="ios-analytics" />内容管理1
								</div>
							</vMenuItem>
							<vMenuItem>
								<div slot="title">
									<vIcon type="ios-analytics" />内容管理2
								</div>
							</vMenuItem>
							<vMenuItem>
								<div slot="title">
									<vIcon type="ios-analytics" />内容管理3
								</div>
								<vMenuItem>
									<div slot="title">
										<vIcon type="ios-analytics" />内容管理4
									</div>
								</vMenuItem>
							</vMenuItem>
						</vMenuItem>
						<vMenuItem>
							<div slot="title">
								<vIcon type="ios-analytics" />内容管理5
							</div>
							<vMenuItem>
								<div slot="title">
									<vIcon type="ios-analytics" />内容管理6
								</div>
							</vMenuItem>
							<vMenuItem>
								<div slot="title">
									<vIcon type="ios-analytics" />内容管理7
								</div>
								<vMenuItem>
									<div slot="title">
										<vIcon type="ios-analytics" />内容管理8
									</div>
								</vMenuItem>
							</vMenuItem>
						</vMenuItem>
